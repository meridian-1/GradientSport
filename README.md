...
- **Parallax Effects**: Dynamic background images
- **Gradient Animations**: Animated gradients in the background
- **Responsive Design**: Works on various devices
- **Smooth Scrolling**: Thanks to the Lenis library

## Dependencies
- GSAP (included in `app/vendor/gsap/`)
- Lenis (included in `app/vendor/lenis/`)
